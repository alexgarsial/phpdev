...
const ERROR_IMAGE_URL = 'L\'image doit être uune URL valide';
    ...
    <div class="container">
        ...
        <div class="content">
            <div class="block p-20 form-container">
                <h1><?= $id ? 'Modifier'  : 'Ajouter' ?> un article</h1>
                <form action="/form-article.php<?= $id ? "?id=$id" : '' ?>" method="POST">
                    ...
                    <div class="form-control">
                        ...
                        <select name="category" id="category">
                            <option <?= !$category || $category === 'technology' ? 'selected' : '' ?> value="technology">Tech</option>
                    ...
                    <div class="form-actions">
                        <a href="/" class="btn btn-seconday" type="button">Annuler</a>
